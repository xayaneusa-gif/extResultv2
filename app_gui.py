...
<div style="font-family: 'Segoe UI', Tahoma, sans-serif; margin-bottom: 24px; background: #ffffff; border: 1px solid #d8dfeb; border-radius: 14px; padding: 18px;">
    ...
    <div style="margin-top:16px;">
        <h3 style="margin:0 0 10px;color:#344054;font-size:16px;">Practical Rankboards</h3>
        {practical_scoreboard_html if practical_scoreboard_html else '<div style="border:1px dashed #d8dfeb;border-radius:12px;padding:12px;background:#fafbff;color:#667085;">No practical rankboards available for this dataset.</div>'}
    </div>
</div>
"""
