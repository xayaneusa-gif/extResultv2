...
"""
    ...
    if practical_panel_html:
        ...
        scoreboard_layout_html = (
            "<div style=\"margin-top:16px;\"><h3 style=\"margin:0 0 10px;color:#344054;font-size:16px;\">Subject Scoreboards</h3>"
            + subject_scoreboard_html
            + "</div>"
        )
